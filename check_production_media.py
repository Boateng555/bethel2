#!/usr/bin/env python
"""
Script to check production media configuration and test image URLs
"""
import os
import requests
...
def check_environment():
    ...
    if debug:
        ...
        print("⚠️ Using local storage (Cloudinary not configured)")
...
def check_media_files():
    ...
    for church in churches:
        ...
        print(f"   Logo: {'✅' if church.logo else '❌'}")
        if church.logo:
