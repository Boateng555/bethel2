#!/usr/bin/env python
"""
Django management command to sync local media files to Cloudinary
Usage: python manage.py sync_media_to_cloudinary
"""
import os
import sys
import django
...
if __name__ == '__main__':
    ...
    # Run the command
    command = Command()
    command.handle(dry_run=True)  # Start with dry run 