...
class Event(models.Model):
    ...
    def card_image(self):
        ...
        first_media = next((media for media in self.hero_media.all() if media.image), None)
        if first_media:
...
class Hero(models.Model):
    ...
    def get_background_image_url(self):
        """Returns the correct URL for the background image field"""
        if self.background_image:
            image_str = str(self.background_image)
            if image_str.startswith('http'):
                return image_str
            else:
    ...
    def get_background_video_url(self):
        """Returns the correct URL for the background video field"""
        if self.background_video:
            video_str = str(self.background_video)
            if video_str.startswith('http'):
                return video_str
            else:
